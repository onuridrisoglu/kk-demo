...
public class Stepper extends Nav implements HasTheme {
    ...
    public void setOrientation(Orientation orientation) {
        ...
        if (orientation.equals(Orientation.HORIZONTAL)) {
            this.list.addClassNames(AlignItems.CENTER, FlexDirection.Breakpoint.Large.ROW);
        } else {
            this.list.removeClassNames(AlignItems.CENTER, FlexDirection.Breakpoint.Large.ROW);
        }
