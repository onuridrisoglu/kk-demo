...
public class Step extends ListItem implements AfterNavigationObserver, HasTheme {
    ...
    private void updateCircleIcon() {
        ...
        switch (this.state) {
            case COMPLETE :
                this.circle.add(VaadinIcon.CHECK.create());
                break;
            case ERROR :
                this.circle.add(VaadinIcon.CLOSE.create());
                break;
        }
    }
    ...
    private void updateCircleClassNames() {
        ...
        this.circle.addClassNames(AlignItems.CENTER, Border.ALL, BorderRadius.LARGE, BoxSizing.BORDER, Display.FLEX,
        ...
        switch (this.state) {
            ...
            case COMPLETE:
                ...
                break;
            case ERROR:
                this.circle.addClassNames(Background.ERROR, BorderColor.ERROR, TextColor.ERROR_CONTRAST);
                break;
            case INACTIVE:
                this.circle.addClassNames(Background.BASE, BorderColor.CONTRAST_30, TextColor.SECONDARY);
                break;
        }
    }
    ...
    private void updateLabelClassNames() {
        ...
        switch (state) {
            case ACTIVE :
                ...
                break;
            case COMPLETE :
                this.label.addClassName(TextColor.BODY);
                break;
            case ERROR :
